...
public class TestingTransactions {
    ...
    public enum TTChecks {
        NONE, QUESTION_SHOWN, ANSWER_SELECTED, QUIZ_SCORE_SHOWN, AVAILABLE_QUIZZES_SHOWN, MAIN_ACTIVITY_SHOWN, EDIT_QUESTIONS_SHOWN, QUESTION_EDITED, NEW_QUESTION_SUBMITTED, AUTHENTICATION_ACTIVITY_SHOWN, LOGGED_OUT
    };
