...
public abstract class QuizQuestion {
     ...
     * 
     * @param questionId
     *            is a unique id associated to each quiz question
     * @param question
     *            is a string that invite the user to answer the quiz question
     * @param answers
     *            is a list of possible answers
     * @param solutionIndex
     *            is the index of the correct solution
     * @param tags
     *            is the set of keyword about what is the question
     */
    ...
    /**
     * @param answerId
     *            is the index of the answer you want to check
     * @return true if answerId is the index of the correct answer else return
     *         false
     */
