...
public class QuestionIterator implements Parcelable {
	 ...
	 * @param query
	 *            is a String representing the query that the questions must
	 *            match
	 * @param next
	 *            is the String token received by the server in case the server
	...
	public QuestionIterator(QuizQuestion[] questions, String query, String next) {
		if (questions == null) {
			throw new IllegalArgumentException(
					"Argument questions cannot be null");
		}
